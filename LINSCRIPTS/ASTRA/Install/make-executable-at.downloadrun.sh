...
DISTRIB=ASTRA
PRODUCTNAME=BHSH
SUBPRODUCTNAME=make-executable-at
FIRM_NAME=NIT
...
aCmdName001=install.package.sh
aCmdName002=main.reinstall.apt.sh
...
aLocalCMDFile=$SCRIPT_DIR/$SUBPRODUCTNAME/$aCmdName002
aLocalCMDFile01=$SCRIPT_DIR/$SUBPRODUCTNAME/$aCmdName001
...
if [ -f $aLocalCMDFile01 ]; then
    chmod +x $aLocalCMDFile01
fi
